...
@section('content')
    ...
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Pekerja Management</h2>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-md">
                                    <tbody>
                                        ...
                                        @foreach ($pekerja as $key => $listPekerja)
                                            <tr>
                                                <td>{{ $pekerja->firstItem() + $key }}</td>
                                                <td>{{ $listPekerja->name }}</td>
                                                <td>{{ $listPekerja->name_role }}</td>
                                                <td class="text-right">
                                                    <div class="d-flex justify-content-end">
                                                        <a href="{{ route('menu-item.edit', $listPekerja->id) }}"
                                                            class="btn btn-sm btn-info btn-icon "><i
                                                                class="fas fa-edit"></i>
                                                            Edit</a>
                                                        <form action="{{ route('menu-item.destroy', $listPekerja->id) }}"
